...
export class CowinService {
  ...
  getDetailsForVaccine(): Observable<any> {

    return this.httpClient.get<any[]>("https://api.cowin.gov.in/api/v1/reports/v2/getPublicReports").pipe(
      tap(_ => console.log('vaccine details')),
      catchError(this.handleError<any>('getStates', []))
